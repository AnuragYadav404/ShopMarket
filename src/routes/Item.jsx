...
import { getItemDetails, getCartItemDetails, handleCartDecrease, handleCartIncrease, handleAddItemToCart} from "../store";
...
export function ItemDetail() {
  ...
  return (
    <div className="itemElement">
      <div className="itemImage"><img src={item.image} alt="" /></div>
      <div className="itemAbout">
        ...
        {count > 0 && <div className="itemButtons">
        ...
        {
          count==0 && <button onClick={() => handleAddToCart(item.id, item.title, item.price, item.image)}>Add to cart</button>
        }
      </div>
    </div>
  );
